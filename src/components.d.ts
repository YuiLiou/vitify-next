...
declare module 'vue' {
  export interface GlobalComponents {
    ...
    CardProjectDispatch: typeof import('./components/CardProjectDispatch.vue')['default']
    CardProjects: typeof import('./components/CardProjects.vue')['default']
    CardTasks: typeof import('./components/CardTasks.vue')['default']
    CardTasksDispatch: typeof import('./components/CardTasksDispatch.vue')['default']
