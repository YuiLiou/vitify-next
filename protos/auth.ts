...
class LoginResponse$Type extends MessageType<LoginResponse> {
    constructor() {
        super("LoginResponse", [
            ...
            { no: 31, name: "roles", kind: "scalar", repeat: 2 /*RepeatType.UNPACKED*/, T: 9 /*ScalarType.STRING*/ },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* optional LoginResponse.Ldap ldap */ 21:
                    message.ldap = LoginResponse_Ldap.internalBinaryRead(reader, reader.uint32(), options, message.ldap);
                    break;
    ...
    internalBinaryWrite(message: LoginResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.ldap)
            LoginResponse_Ldap.internalBinaryWrite(message.ldap, writer.tag(21, WireType.LengthDelimited).fork(), options).join();
...
class LoginResponse_Ldap$Type extends MessageType<LoginResponse_Ldap> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: LoginResponse_Ldap): LoginResponse_Ldap {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: LoginResponse_Ldap, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
...
], { "google.api.default_host": "192.168.197.152" });
